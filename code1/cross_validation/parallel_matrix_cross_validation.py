...
class ParallelMatrixCrossValidation(MatrixCrossValidation):
    def __init__(self, method, R, M, K, parameter_search, train_config, predict_config, file_performance, P):
        MatrixCrossValidation.__init__(self, method, R, M, K, parameter_search, train_config, predict_config,
                                       file_performance)
        self.P = P
    ...
    def run_model(self, train, test, parameters):
        raise Exception(
            "Using wrong method for ParallelMatrixCrossValidation! Use the one defined outside of the class.")
