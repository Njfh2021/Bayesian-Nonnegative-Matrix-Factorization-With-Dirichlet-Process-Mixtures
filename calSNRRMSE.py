...
for x in xrange(1, 2):
    ...
    for r in [5]:
        ...
        X_Noi = scio.loadmat('Syntheticdata/X_Noi_Sparse_{}.mat'.format(x))['X_Noi_Mixture'].astype(float)
        I, J = X_Noi.shape
        M = np.ones((I, J))
        # for r in [4]:
        # print("r is: {}".format(r))
...
scio.savemat('GaussianTotalError.mat', {'totalError': total_Error})
scio.savemat('MixturemeanError.mat', {'meanError': meanError})
