...
from code.models.bnmf_vb_Audio import bnmf_vb_Audio
...
X_Noi = scio.loadmat('Caoyuan_ImgData/twoD.mat')['twoD'].astype(float)
...
for r in range(min_R, max_R + 1):
    ...
    for k in K_List:
        ...
        noise = X_Noi - result
        scio.savemat('Caoyuan_ImgData/resultR{}.mat'.format(r), {'result':result})
        scio.savemat('Caoyuan_ImgData/noiseR{}.mat'.format(r), {'noise':noise})
