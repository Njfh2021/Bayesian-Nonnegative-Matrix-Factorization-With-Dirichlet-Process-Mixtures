...
for rest in totalRest:
    for sub in range(0, totalsubject+1):
        for repe in range(0,totalRepe+1):
            print("Rest: {}, repe: {}".format(rest, repe))
            X_Noi = scio.loadmat('6move/mrest0repe0.mat' )['matrix'].astype(float)
            ...
            for r in range(min_R, max_R + 1):
                ...
                for k in K_List:
                    ...
                    scio.savemat('6moveResult/V.mat', {'V':V})
                    scio.savemat('6moveResult/U.mat', {'U':U})
