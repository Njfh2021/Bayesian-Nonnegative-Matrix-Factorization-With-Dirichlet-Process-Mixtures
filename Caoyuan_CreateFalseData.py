...
if __name__ == "__main__":
    ...
    p1 = int(math.floor(I * J * 0.3))
    x_Noi_Mixture_1D[Ind[0:p1]] = x_Noi_Mixture_1D[Ind[0:p1]] + np.random.randn(p1) * 0.81
    # print("All good till Here")
    p2 = int(math.floor(I * J * 0.3))
    x_Noi_Mixture_1D[Ind[p1:p1 + p2]] = x_Noi_Mixture_1D[Ind[p1:p1 + p2]] + (
                np.random.rand(p2) * 20) - 10  # Add uniform noise
    p3 = int(math.floor(I * J * 0.4))
